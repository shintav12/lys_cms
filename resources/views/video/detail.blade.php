                	...
                	if($(".kv-fileinput-error").css("display") == "block"){
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                if (error == 0) {
                                    window.location = "{{ url(route('videos'))}}";
                                } else {
                                    swal.close();
                                    swal(
                                        'Oops...',
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="col-xs-12">
                                                    <label>Video</label>
                                                    <textarea class="form-control" name="video"> <?php if(isset($item)) echo $item->video;?> </textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="col-md-3 col-md-9">
                                        ...
                                        <a type="button" href="{{route("videos")}}" class="btn default">Cancel</a>
                                    </div>
                                </div>
                            </div>
                        </div>
