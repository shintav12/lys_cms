    ...
    <script class="text/javascript">
        $(document).ready(function(){
            ...
            $("#frebie_file").fileinput({
                ...
                <?php if(isset($item)){?>
                initialPreview: [
                    "<?php echo config('app.path_url').$item->download.'?v='.strtotime($item->updated_at) ?>",
                ]
                <?php }?>
            });
                	...
                	if($(".kv-fileinput-error").css("display") == "block"){
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                if (error == 0) {
                                    window.location = "{{ url(route('frebies'))}}";
                                } else {
                                    swal.close();
                                    swal(
                                        'Oops...',
                                ...
                                <div class="row form-body">
                                        ...
                                        <div class="form-group ">
                                            <div class="col-xs-12">
                                                <div class="col-xs-12">
                                                    ...
                                                    <input id="frebie_file" class="input-fixed" name="frebie_file" type="file">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    {{--<div class="col-xs-12">--}}
                                        {{--<div class="form-group">--}}
                                            {{--<div class="col-xs-12">--}}
                                                {{--<div class="col-xs-12">--}}
                                                    {{--<!--<a href="#" data-type="FACEBOOK" class="btn btn-primary custom-embed"><i class="fa  fa-facebook"></i> Embed facebook</a>-->--}}
                                                    {{--<a href="#" data-type="TWITTER" class="btn btn-primary custom-embed"><i class="fa  fa-twitter"></i> Embed Twitter</a>--}}
                                                {{--</div>--}}
                                            {{--</div>--}}
                                        {{--</div>--}}
                                    {{--</div>--}}
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="col-md-3 col-md-9">
                                        ...
                                        <a type="button" href="{{route("posts")}}" class="btn default">Cancel</a>
                                    </div>
                                </div>
                            </div>
                        </div>
